...
import 'package:modern_quiz_app/data/remote/quiz_service.dart' show QuizRemoteDataSource;
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final quizRepository = QuizRepository(remoteDataSource: quizRemoteDataSource);
